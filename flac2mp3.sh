#!/bin/bash
#
# Script for converting flac to mp3 
# @author mgyk
# @dependencies flac, lame, cuetools, shntool
# sudo apt-get install flac lame cuetools shntool

# @help http://www.webupd8.org/2009/04/split-ape-and-flac-files-in-ubuntu-and.html
...
# directory for saving mp3
prefix=/home/lucidyan/Downloads/_mp3
